...
- **既に書かれた、要求を述べない記述に限り「特定時点の記録」として凍結でき、現況へ改めなくてよい。** 凍結するなら、(i) 記録である旨を字面でラベルし、(ii) 現況の持ち主を併記し、(iii) **内容が当時真であったことを出所に当たって確認し、出所を同じ節の字面に残す**。3点のいずれかを欠くものは記録として扱わず、現況へ改める
